...
extension ClipboardItem {
    ...
    @NSManaged var pinnedTimestamp: Date?
    ...
    var image: NSImage? {
        ...
        if let cached = ClipboardItem.imageCache.object(forKey: cacheKey) {
            return cached
        }
        ...
        ClipboardItem.imageCache.setObject(image, forKey: cacheKey)
